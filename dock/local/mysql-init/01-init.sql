...
CREATE TABLE IF NOT EXISTS TEACHER (
  ...
  county VARCHAR(50) COMMENT '縣市 County',
  district VARCHAR(50) COMMENT '區域 District',
  address VARCHAR(255) COMMENT '地址 Address',
  teaching_categories JSON NOT NULL COMMENT '教學種類 Teaching Categories',
  level VARCHAR(50) NOT NULL COMMENT '等級 Level',
  years_of_experience INT NOT NULL DEFAULT 0 COMMENT '教學年資 Years of Experience',
  specialty VARCHAR(255) NOT NULL COMMENT '專長 Specialty',
  hourly_rate DECIMAL(10, 2) NOT NULL COMMENT '時薪 Hourly Rate',
  emergency_contact_name VARCHAR(100) COMMENT '緊急聯絡人姓名 Emergency Contact Name',
  emergency_contact_relation VARCHAR(50) COMMENT '緊急聯絡人關係 Emergency Contact Relation',
  emergency_contact_phone VARCHAR(20) COMMENT '緊急聯絡人電話 Emergency Contact Phone',
